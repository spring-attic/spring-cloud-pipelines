...
A common way of running, configuring and deploying applications equals lower costs required
to support it and lower time needed by new developers to blend in when they change projects.
