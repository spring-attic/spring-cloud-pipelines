...
[source,bash]
----
cf delete-route local.pcfdev.io -n github-webhook-test
cf delete-route local.pcfdev.io -n github-eureka-test
cf delete-route local.pcfdev.io -n stubrunner-test
----
