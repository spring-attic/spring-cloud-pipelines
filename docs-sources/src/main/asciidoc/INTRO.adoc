...
That's why we're using the https://github.com/spring-cloud/spring-cloud-repository-management[Project Crawler]
...
will be picked and pipelines will be created for them. Project Crawler supports
